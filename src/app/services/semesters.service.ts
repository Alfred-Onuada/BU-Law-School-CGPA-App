...
export class SemestersService {
  ...
  createSemester(name: string, sessionId: string): Observable<IApiResponse> {
    return this.http.post<IApiResponse>(`${environment.apiUrl}/sessions/${sessionId}/semesters`, { name });
  }
}
